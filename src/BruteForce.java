...
public class BruteForce {
	...
	static void printPartitions(int n, int max, ArrayList<Integer> list, ArrayList<ArrayList<Integer>> comp) {
		if (n == 0) {
	...
	public static int walkGraph(int[][] graph, ArrayList<Integer> list) {
		int i = 0, j = 0, cost = 0;
